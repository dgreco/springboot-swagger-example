...
kubectl create secret generic springboot-swagger-example-admin-server \
	--from-file $dir/../admin-server/src/main/resources/application.yaml \
	--from-file $dir/../admin-server/src/main/resources/application-dev.yaml \
	--from-file $dir/../admin-server/src/main/resources/application-prod.yaml \
	--from-file $dir/../admin-server/src/main/resources/logback-spring.xml
kubectl delete -f $dir/springboot-swagger-example-admin-server.yml
kubectl create -f $dir/springboot-swagger-example-admin-server.yml